...
p2 <- ggplot(correct_df, aes(x=V1, y=V2, col=c(meta_pijuan$stage))) + 
  geom_point(size=0.01) + 
  theme_bw() +
  theme(
    plot.background = element_blank(),
...
p3 <- ggplot(correct_df, aes(x=V1, y=V2, col=c(meta_pijuan$celltype.general))) + 
  geom_point(size=0.01) + 
  theme_bw() +
  theme(
    plot.background = element_blank(),
...
ggsave(
  paste0(outFolder, "p2_pijuanStage.pdf"),
  plot = p2,
  device = NULL,
  path = NULL,
  #  scale = 1,
...
ggsave(
  paste0(outFolder, "p3_pijuanCelltypeGeneral.pdf"),
  plot = p3,
  device = NULL,
  path = NULL,
  #  scale = 1,
